                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="btc" value="3FZbgi29cpjq2GjdwV8eyHuJJnkLtktZc5" aria-label="btc wallet" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="eth" value="0x71c7656ec7ab88b098defb751b7401b5f6d8976f" aria-label="eth wallet" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="ltc" value="3CDJNfdWX8m2NwuGUV3nhXHXEeLygMXoAj" aria-label="ltc wallet" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="paypal" value="example-email@centcoin.com" aria-label="paypal address" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="venmo" value="example-email@centcoin.com" aria-label="venmo address" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row ml-5 mt-5">
                                            ...
                                            <div className="col-md-7">
                                                <div className="input-group mb-4">
                                                    ...
                                                    <input type="text" className="form-control" id="zelle" value="example-email@centcoin.com" aria-label="venmo address" aria-describedby="basic-addon1" required />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    <button className="btn btn-dark btn-sm  mt-5 mb-3 float-right">Send Proof</button>
                                </div>
                            </div>
                        </div>
                    </Body>
